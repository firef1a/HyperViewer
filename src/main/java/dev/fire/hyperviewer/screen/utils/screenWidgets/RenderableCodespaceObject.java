...
import dev.fire.hyperviewer.screen.utils.RectBorder;
...
public class RenderableCodespaceObject extends RenderableRectangleObject implements RenderableObject {
    ...
    public int getMaxScrollX() {
        ...
        if (!codeScreen.functionEntryList.isEmpty()) {
            FunctionEntry functionEntry = codeScreen.functionEntryList.get(HyperViewer.functionDataManager.focusedFunctionEntry);
    ...
    public int getMaxScrollY() {
        ...
        int margin = 5;
        if (!codeScreen.functionEntryList.isEmpty() && codeScreen.functionEntryList.get(HyperViewer.functionDataManager.focusedFunctionEntry).formattedCodeList.size() > codespace_size_before_scroll) {
            ArrayList<CodeLine> getCode = codeScreen.functionEntryList.get(HyperViewer.functionDataManager.focusedFunctionEntry).formattedCodeList;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, int parentx, int parenty, int parentWidth, int parentHeight) {
        ...
        if (!codeScreen.functionEntryList.isEmpty()) {
            FunctionEntry function = codeScreen.functionEntryList.get(HyperViewer.functionDataManager.focusedFunctionEntry);
